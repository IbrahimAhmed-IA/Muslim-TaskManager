      ...
      {showNotesList ? (
        <div className="space-y-4">
          <div className="flex justify-between items-center mb-5">
            <h3 className={`text-sm font-medium ${isAdvancedMode ? "text-slate-100" : "text-gray-700"}`}>
              Your Notes
            </h3>
            <Button
          ...
          {notes.length === 0 ? (
            <div className={`text-center py-8 border border-dashed rounded-lg ${
              ...
              <div className={`inline-flex p-3 rounded-full mb-3 ${
                ...
                <FaStickyNote className={isAdvancedMode ? "text-indigo-400" : "text-indigo-500"} size={16} />
              </div>
