...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
        <div
          className={`h-full page-header py-0.5 px-4 flex justify-between items-center shadow-lg ${
      ...
      <div className="flex min-h-screen pt-[45px]">
        ...
        <div
          className={`sidebar w-20 fixed left-0 top-[45px] h-[calc(100vh-45px)] z-20 shadow-xl transition-all duration-300 ease-in-out ${
            settings.advancedMode
              ? "bg-gradient-to-b from-slate-800 via-slate-900 to-slate-950 shadow-blue-900/20"
              : "bg-gradient-to-b from-indigo-600 via-purple-600 to-purple-800"
          }`}
        >
          {/* Empty space at the top of sidebar */}
