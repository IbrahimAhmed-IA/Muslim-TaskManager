      ...
      <div className="flex h-full items-center">
        <div className="flex-1 flex flex-col justify-center">
          <div className="flex justify-end items-center">
            {nextPrayer && (
              <div className="bg-white/20 px-2.5 py-1 rounded text-[13px] mr-2.5 leading-tight whitespace-nowrap max-w-[calc(100vw-60px)] overflow-hidden text-ellipsis font-medium">
          ...
          {prayerTimes && (
            <div className="grid grid-cols-6 gap-px text-center text-[12px] leading-tight mt-1.5 font-medium">
              <div>
